...
\chapter{Operating the Ground Control Software}
	...
	\section{Configuring the Payload}
		...
		\subsection{Adding Target Frequencies}
			\begin{enumerate}
				...
				\item Enter the value of the desired target frequency. The system will only accept a valid target frequency within the following range: [center frequency - sampling frequency, center frequency + sampling frequency]. 
				...
				\item Click on the button labeled "Update" contained within the "System Settings" drop-down.
			\end{enumerate}
		\subsection{Deleting Target Frequencies}
			\begin{enumerate}
				...
				\item Click on the button labeled "Update".
			\end{enumerate}
	...
	\section{Checking on the Payload Status}
		...
		\begin{enumerate}
			\item Not Connected: At least one of the components of the payload is not ready to record.
			\item Idle: All components of the payload are ready.
			\item Running: The payload is recording.
			\item Stopping: The payload is in the process of ending the recording.
			\item Failed: At least one of the components of the payload has failed.
		\end{enumerate}
		...
		\end{enumerate}
		\subsection{Checking the Status of Individual Components Within Payload}
			\begin{enumerate}
				\item With the GCS open and connected to the payload, locate the series of drop-downs in the right-most column of the user interface.
				\item Expand the drop-down labeled "Components".
